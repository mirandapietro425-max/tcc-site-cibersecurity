/* CyberShield Hexad — consolidated runtime. Image-first fallback precedes the cinematic module. */
(() => {
  'use strict';
  ...
  const frames = [
    {id:1,start:0.0,end:4.532,chapter:0},
    ...
    {id:25,start:72.464,end:80.509,chapter:1},
    {id:26,start:80.509,end:80.589,chapter:2},
    ...
    {id:36,start:114.364,end:114.444,chapter:3},
    {id:37,start:114.444,end:114.524,chapter:3},
    {id:38,start:114.524,end:117.887,chapter:3},
    ...
    {id:46,start:138.52,end:163.683,chapter:3},
    {id:47,start:163.683,end:163.763,chapter:4},
    {id:48,start:163.763,end:163.843,chapter:4},
    ...
    {id:57,start:205.271,end:223.53,chapter:4},
    {id:58,start:223.53,end:223.61,chapter:5},
    {id:59,start:223.61,end:223.69,chapter:5},
    ...
    {id:68,start:256.314,end:274.756,chapter:5},
    {id:69,start:274.756,end:274.836,chapter:6},
    {id:70,start:274.836,end:274.916,chapter:6},
    ...
    {id:79,start:322.668,end:336.039,chapter:6},
    {id:80,start:336.039,end:336.119,chapter:7},
    {id:81,start:336.119,end:336.199,chapter:7},
    ...
    {id:90,start:365.323,end:373.825,chapter:7},
    {id:91,start:373.825,end:373.905,chapter:7},
    {id:92,start:373.905,end:374.77,chapter:7},
    {id:93,start:374.77,end:374.85,chapter:7},
    {id:94,start:374.85,end:375.715,chapter:7},
    {id:95,start:375.715,end:375.795,chapter:7},
...
/* Cinematic/WebGL controller consolidated from V72. */
