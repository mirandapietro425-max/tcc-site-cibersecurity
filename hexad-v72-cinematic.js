...
function openFrameViewer(i){
  ...
  if(!viewer){
    viewer=document.createElement('aside');viewer.id='hx71-frame-viewer';viewer.className='hx71-frame-viewer';
    viewer.innerHTML=`<button class="hx71-close" id="hx71-frame-close">FECHAR ×</button><img id="hx71-frame-img" alt=""><div><b id="hx71-frame-title"></b><span>STORYBOARD AUDITADO</span></div>`;
...
function toggleFilm(){
  ...
  if(experience.playing) lastRAF=performance.now();
