...
(() => {
  ...
  start?.addEventListener('click',()=>{ if(started)return; started=true; setAudio(true); if(hud)hud.hidden=false; playSfx('transition',.22); if(boot){boot.classList.add('is-done'); setTimeout(()=>boot.remove(),1100);} });
